...
def HexConverter():
    ...
    user_number = int(input("Choose an integer to convert into Hexadecimal.\nR: "))
    ...
    if user_number < 0:
        ...
        print(f"\n{starter_num} in Hexadecimal is: ",''.join(str(x) for x in converted_hex[::-1]))
...
def main():
    ...
    converter_choice = input("\nInteger to Binary, Hexadecimal or Octal converter.\n" \
    "Choose a converter \n1.Binary \n2.Hexadecimal \n3.Octal\nR: ")
